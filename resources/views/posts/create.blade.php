...
@section('title', '日記作成 | ' . config('app.name'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group js-imagePicker">
                            ...
                            <div style="max-width: 480px; display: none;" class="js-imagePicker--previewWrapper">
                                <div style="max-width: 400px;" class="d-inline-block mt-2">
                                    <img src="" alt="" class="js-imagePicker--preview img-fluid img-thumbnail" />
                                </div>
                            </div>
                            @error('picture')
                                <div class="text-xs text-danger">{{ $message }}</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            {!! Form::select('status', \App\Enums\PublicStatus::asSelectArray(), old('status', \App\Enums\PublicStatus::NotPublic), ['class' => 'form-control']) !!}
                        </div>
                        <div class="text-center">
                            <button type="submit" class="btn btn-block btn-primary">作成</button>
